...
这将是本人为期数月的学习计划。我正要从一名网络安全转型成为一名机器学习工程师。

内容源自github项目[machine-learning-for-software-engineers](https://github.com/ZuzooVn/machine-learning-for-software-engineers)
...
[机器学习有两个方向](http://machinelearningmastery.com/programmers-can-get-into-machine-learning/)：
